...
func main() {
	...
	display.PrintLargestDirectories(previous.LargestFiles, repositoryInformation.TotalCommits, repositoryInformation.TotalTrees, repositoryInformation.TotalBlobs, repositoryInformation.CompressedSize)
